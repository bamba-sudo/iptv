...
<body>
	<div class="container jumbotron bg-dark text-center">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="text-white"> TestPanier </h1>
			</div>
		</div>	
	</div>
				...
				<ul class="list-group list-group-flush">
  					<li class="list-group-item bg-dark">
  						<?php 
							...
							$unPanier = new Panier(201, 300, 1, 4);

							echo $unPanier->getIdPanier();
  						?>
  					</li>
  					<li class="list-group-item bg-dark">
  						<?php
  							echo $unPanier->getIdProduit();
  						?>
  					</li>
  					<li class="list-group-item bg-dark">
  						<?php
  							echo $unPanier->getIdClient();
  						?>
  					</li>
  					<li class="list-group-item bg-dark">
  						<?php
  							echo $unPanier->getQuantite();
  						?>
  					</li>
				</ul>				
			</div>
