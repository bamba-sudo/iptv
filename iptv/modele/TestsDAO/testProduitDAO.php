			...
			<div class="col-sm-12">
              ...
              echo "</ul";
  					...
  					<li class="list-group-item bg-dark">
  						...
  						$unProduit2 = ProduitDAO::chercherAvecFiltre("WHERE add_mag='123456'");
              ...
              echo "</ul";
  					...
  					<li class="list-group-item bg-dark">
  						...
  						$unProduit3 = new Produit();

  						ProduitDAO::inserer($unProduit3);

  						$unProduit3 = ProduitDAO::chercher();
              ...
              echo $unProduit10 ? "<ul><li>".$unProduit10."</li></ul>" : "aucun produit";
  					...
  					<li>
  						...
  						$unProduit5 = ProduitDAO::chercher(200);
              echo $unProduit5;
