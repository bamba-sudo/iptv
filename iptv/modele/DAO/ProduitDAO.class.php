	...
	*/
	...
	class ProduitDAO implements DAO {	
		...
		static public function modifier($unProduit) {
			...
			$commandeSQL .= ",description='".$unProduit->getDescription()."',image='".$unProduit->getImage()."'";
			$commandeSQL .= ",prix=".$unProduit->getPrix().",quantite_stock=".$unProduit->getQuantiteStock()."quantite_commander=".$unProduit->getQuantiteCommander().",rating="$unProduit->getRating()." where id_produit=".$unProduit->getIdProduit();
